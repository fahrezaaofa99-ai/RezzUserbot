...
<blockquote>{bot.me.mention}
    status: {status} 
       {psr} expired_on: {exp} 
        ...
        <blockquote><b>USERBOT 10K/BULAN BY @RezzUbott_bot</b></blockquote>
"""
...
async def _(client, callback_query):
    ...
    os.execl(sys.executable, sys.executable, "-m", "ʀᴇᴢᴢᴜsᴇʀʙᴏᴛ-ᴠᴠɪᴘ")
